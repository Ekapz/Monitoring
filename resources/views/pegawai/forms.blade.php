      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <input type="text" name="nomortelepon" placeholder="Nomor Telepon" value="{{$newPegawai->notelp or ''}}" class="form-control col s6" data-inputmask='"mask": "(999) 999-9999"' data-mask required></label><br>
          </div>
